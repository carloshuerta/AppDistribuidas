...
namespace AppDistribuidas.Controllers
{
    ...
    public class UnidadesController : ControllerBase
    {
        ...
        public UnidadesController(ApplicacionesDistribuidasContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Unidade>> PostUnidade(Unidade unidade)
        {
          if (_context.Unidades == null)
          {
              return Problem("Entity set 'ApplicacionesDistribuidasContext.Unidades'  is null.");
          }
            _context.Unidades.Add(unidade);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetUnidade", new { id = unidade.IdUnidad }, unidade);
        }
